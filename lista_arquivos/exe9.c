...
int main() {
    long long valor_minimo;
    printf("Digite o valor mínimo para listar os recebimentos: ");
    scanf("%lld", &valor_minimo);
    ...
    printf("\n=== Recebimentos com valor acima de %lld ===\n", valor_minimo);
    ...
    if (!encontrou) {
        printf("Nenhum recebimento encontrado com valor acima de %lld.\n", valor_minimo);
    }
